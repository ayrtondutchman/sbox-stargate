...
{
    [Library]
	public partial class PlayerWalkController : BasePlayerController
    {
        ...
        public virtual void StepMove()
        {
			...
			mover.Trace = Stargate.GetAdjustedTraceForClipping( Pawn, mover.Trace );
		...
		public override TraceResult TraceBBox( Vector3 start, Vector3 end, Vector3 mins, Vector3 maxs, float liftFeet = 0.0f )
		{
			...
			trace = Stargate.GetAdjustedTraceForClipping( Pawn, trace );
